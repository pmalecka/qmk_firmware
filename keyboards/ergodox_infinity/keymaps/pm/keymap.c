...
#define LSC_T(kc) MT((MOD_LCTL | MOD_LSFT), kc)  // Ctrl-Shift
 ...
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   | FNx  | LALT | LEFT |  UP  |  ~L1 |                                       | ~L2  | LEFT | DWN  |  UP  | RGHT |
 *   `----------------------------------'                                       `----------------------------------'
 *                                        ,-------------.       ,-------------.
 *                                        | HOME | END  |       | RALT | RCTL |
 *                                 ,------|------|------|       |------+--------+------.
 ...
 * |---------+------+------+------+------+------+------|           |------+------+------+------+------+------+--------|
 * | MsWhUp  | Lclk | MsUp | Rclk |      |      | Vol+ |           |      |      |      | INS  |      | PRSC |   F12  |
 * |---------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
 * | MsWhDwn |MsLeft|MsDown|MsRght|      |      |------|           |------| Left |  Up  | Down | Rght |      |        |
 * |---------+------+------+------+------+------| Vol- |           |      |------+------+------+------+------+--------|
...
[MOTION] = KEYMAP(
       ...
       KC_WH_U,   KC_BTN1,  KC_MS_U,     KC_BTN2,   KC_NO,      KC_NO,          KC_VOLU,
...
qk_tap_dance_action_t tap_dance_actions[] = {
  ...
  [8] = ACTION_TAP_DANCE_DOUBLE(KC_TAB,  LALT(KC_TAB)),        // TAB / switch windows (windows)
...
void matrix_scan_user(void) {
    ...
    // if (IS_LAYER_ON(2)) {
    //     ergodox_right_led_2_set(LED_BRIGHTNESSS_HI);

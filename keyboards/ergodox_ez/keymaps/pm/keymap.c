 ...
 * |---------+------+------+------+------+------+------|           |------+------+------+------+------+------+--------|
 * |         |      | Lclk | MsUp | Rclk | Vol+ | MUTE |           |      |  INS | PGUP |  Up  | HOME |      |  F12   |
 * |---------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
 * |         |MsWhUp|MsLeft|MsDown|MsRght| Vol- |------|           |------| PSCR | Left | Down | Rght |      |        |
 * |---------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
 * |         |MsWhDn|      |      |      |      |      |           |      | Calc | PGDN |      | END  | Edit |        |
 * `---------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   |       |      |      |      |      |                                       |      | HOME | PGDN | PGUP | END  |
 *   `-----------------------------------'                                       `----------------------------------'
 *                                        ,-------------.       ,-------------.
...
[_LOWER] = LAYOUT_ergodox(
       ...
       KC_TRNS,   KC_TRNS,  KC_TRNS,     KC_TRNS,   KC_TRNS,
                                                                KC_MPLY,    KC_MNXT,
                                                                            KC_SCRT1,
                                                    KC_TRNS,    KC_TRNS,    KC_SCRT2,
       // right hand
       KC_NO,     KC_F6,     KC_F7,      KC_F8,     KC_F9,      KC_F10,     KC_F11,
       KC_NO,     KC_INS,    KC_HOME,    KC_UP,     KC_PGUP,    KC_NO,      KC_F12,
                  KC_PSCR,   KC_LEFT,    KC_DOWN,   KC_RGHT,    KC_NO,      KC_TRNS,
       KC_NO,     KC_CALC,   KC_END,     KC_NO,     KC_PGDN,    KC_EDITOR,  KC_TRNS,
...
void matrimatrix_init_keymap(void) {
